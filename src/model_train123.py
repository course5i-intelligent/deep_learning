...
def train_model(config_file):
    ...
    if train == True:
        ...
        loss = config["img_augment"]["class_mode"]
        ...
        train_gen = ImageDataGenerator(rescale=1./255,shear_range=shear_range,zoom_range=zoom_range,horizontal_flip=horizontalf,vertical_flip=verticalf,rotation_range=90)
        ...
        print("model is not trained Mohammed")
...
if __name__ == "__main__":
    ...
    train_model(config_file=parsed_args.config)